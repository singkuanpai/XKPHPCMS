...
function DoRemote(){
	if (isset($_POST["editor_UploadText"])){
		$sContent = stripslashes($_POST["editor_UploadText"]);
	}else{
		$sContent = "";
	}
	...
	echo "<HTML><HEAD><TITLE>editor</TITLE><meta http-equiv='Content-Type' content='text/html; charset=utf-8'></head><body>".
