...
function editor_Content(){
	...
	<tr><th colspan=2>editor 3.8 版权、常用联系方法、技术支持</th></tr>
	<tr>
		<td width="15%">软件版本：</td>
		<td width="85%">editor Version 3.8 简体中文专业版</td>
	</tr>
	<tr>
		<td width="15%">版权所有：</td>
	...
	<tr>
		<td width="15%">产品介绍：</td>
		<td width="85%"><a href="http://www.editor.net" target=_blank>http://www.editor.net</a></td>
	</tr>
	<tr>
		<td width="15%">论坛地址：</td>
